...
export default function WellnessScoreCard({ score, projectedScore, label, subtext, delay = 0 }) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay }}
      className="rounded-2xl border border-slate-700 bg-surface p-6 shadow-lg flex flex-col items-center justify-center text-center gap-4 relative"
    >
      ...
      {projectedScore !== undefined && (
        <div className="mt-2 bg-slate-800 rounded px-4 py-2 text-xs">
          <span className="text-slate-400">30-Day Projection (Digital Twin): </span>
